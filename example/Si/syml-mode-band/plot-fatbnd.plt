...
plot "fatbnd-atom-1-spdf.dat" using 1:2 with lines ls 3 notitle,\
     "fatbnd-atom-1-spdf.dat" using 1:2:($3*10) with points lt 3 pt 4 ps variable notitle,\
     "fatbnd-atom-1-spdf.dat" using 1:2:($4*10) with points lt 4 pt 6 ps variable notitle,\
     "fatbnd-atom-1-spdf.dat" using 1:2:($5*10) with points lt 5 pt 8 ps variable notitle,\
