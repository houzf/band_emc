...
set output "VB-ke-$dirt-fitted.eps"     # name of output file
...
a=`grep 'a               = ' fit.log | tail -1 | awk '{printf "%12.6f\n", $3}'`
p=`grep 'p               = ' fit.log | tail -1 | awk '{printf "%12.6f\n", $3}'`
u=`grep 'u               = ' fit.log | tail -1 | awk '{printf "%12.6f\n", $3}'`
...
set encoding iso_8859_1
set terminal postscript eps enhanced color  "Times-Roman" 35
set output "CB-ke-$dirt-fitted.eps"     # name of output file
...
e=`grep 'e               = ' fit.log | tail -1 | awk '{printf "%12.6f\n", $3}'`
if [ ! -f EM-GNUPLOT.out  ]; then
